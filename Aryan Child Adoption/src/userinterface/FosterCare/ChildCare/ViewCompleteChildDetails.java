...
public class ViewCompleteChildDetails extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblHeading.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        lblPersonalInfo.setFont(new java.awt.Font("Arial Black", 1, 14)); // NOI18N
        ...
        lblRegistDate.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        ...
        lblIdenMark.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        lblIdenMark.setText("Identification mark");
        add(lblIdenMark, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 160, 130, 30));

        btnRequestFunds.setFont(new java.awt.Font("Arial Black", 1, 12)); // NOI18N
        ...
        requestMedicalHelpBtn.setFont(new java.awt.Font("Arial Black", 1, 13)); // NOI18N
        ...
        lblPulse.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
        ...
        tblRequest.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        tblRequest.setFont(new java.awt.Font("Arial Black", 0, 12)); // NOI18N
